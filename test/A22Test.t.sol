...
contract A22Test is Test {
    MistypedConstructorToken token;
    ...
    function setUp() public {
        ...
        vm.prank(deployer);
        token = new MistypedConstructorToken();
    }
    ...
    function testConstructorVulnerability() public {
        ...
        // 2. Attacker calls the "constructor" to become admin
        vm.prank(attacker);
        token.constructor(); // Successfully executes!
